...
for (i in filenames){  
  ...
  assign(name, read_csv(here("nationalstats", i)))
}
...
for (i in filenames){  
  ...
  assign(name, read_csv(here("MA4", i)))
}
...
title <- element_text(face = "bold", size = 14, hjust =.5)
...
inspect1000bar <- ggplot(inspectionsper1000, aes(fill=Region, y=Inspectionsper1000, x=Program))+
  ...
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.border = element_blank(),
        ...
        axis.text.y=largernumbers2, axis.title.y=largernumbers,plot.title = title,
        axis.text.x=largernumbers, legend.position = c(0.8, 0.5))
inspect1000bar
